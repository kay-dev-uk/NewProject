    ...
    <>
      <div id='top' className="flex flex-col items-center justify-center h-screen">
        ...
        <div className="mt-8 -mt-[-5vh]">
          <button className="icon-back hover:bg-white hover:animate-pulse hover:text-blue-500 text-cyan-700 border-blue-500 shadow-custom font-semibold py-2 px-4 rounded-lg shadow" onClick={() => scrollToSection('mid')}>
            Get to know me
          </button>
        </div>
      </div>
      <div id='mid' className="flex flex-col sm:flex-row justify-between">
        <div className="lg:mr-5 sm:order-first order-last sm:ml-20 mb-5 ml-10 mr-10 flex flex-col items-center justify-center md:w-3/5">
          <div className="pl-8 pr-8 pt-8 pb-8">
            <h2 className="text-4xl text-cyan-500 font-bold pb-2 flex items-center justify-center">Hello and welcome to my portfolio website!</h2>
            <p className="text-black md:font-sm flex items-center justify-center">Software Developer with experience across the full development lifecycle with a strong foundation in frontend & backend.
            ...
            <Link to='/about' className='flex items-center justify-center' onClick={handleScrollToTop}>
              <button className="icon-back hover:bg-white hover:text-blue-500 text-cyan-700 font-semibold py-2 px-4 rounded-lg shadow-custom animate-bounce">
                Learn more
              </button>
            </Link>
          </div>
        </div>
      <div className="lg:ml-5 sm:mr-20 mr-10 mb-5 ml-10 justify-center items-center md:w-2/5">
        <div>
          <img
            className="rounded-xl shadow-custom w-auto h-3/5 order-first sm:order-last"
      ...
      <div class="grid grid-cols-3 gap-10 mb-10 sm:m-20 m-10">
        <Link to='/work/kanban' onClick={handleScrollToTop}>
          <div class=" flex-grow rounded-xl shadow-custom p-0 transition-all hover:scale-105 hover:shadow-custom hover:cursor-pointer hover:bg-cyan-400 hover:text-white">
        ...
        <Link to='/work/flipping' onClick={handleScrollToTop}>
          <div class=" flex-grow rounded-xl shadow-custom p-0 transition-all hover:scale-105 hover:shadow-red hover:cursor-pointer hover:bg-cyan-400 hover:text-white">
            <div class="aspect-w-1 aspect-h-1">
